...
inline size_t utf16_str_utf8_size(const char16_t *utf16_str) {
...
inline int utf16_strcmp(const char16_t *utf16_str1, const char16_t *utf16_str2) {
...
char16_t *utf16_strchr(const char16_t *utf16_str, const char16_t *utf16_char) {
	if (utf16_strlen(utf16_char) != 1) {
		return NULL;
	}
...
inline char16_t *utf8_char_to_utf16(const unsigned char *utf8_char) {
...
inline unsigned char *utf16_char_to_utf8(const char16_t *utf16_char) {
...
char16_t *utf32_char_to_utf16(char32_t utf32_char) {
	...
	char16_t *utf16_char = (char16_t *)malloc((utf16_code_point_len + 1) * sizeof(char16_t));
...
inline char16_t *utf8_str_to_utf16(const unsigned char *utf8_str) {
...
inline unsigned char *utf16_str_to_utf8(const char16_t *utf16_str) {
	return utf32_str_to_utf8(utf16_str_to_utf32(utf16_str));
}

char32_t *utf16_str_to_utf32(const char16_t *utf16_str) {
	char32_t *utf32_str = (char32_t *)malloc((utf16_strlen(utf16_str) + 1) * sizeof(char32_t));
...
char16_t *utf32_str_to_utf16(const char32_t *utf32_str) {
	char16_t *utf16_str = (char16_t *)malloc(
		(utf32_str_utf16_size(utf32_str) + 1) * sizeof(char16_t)
	);
