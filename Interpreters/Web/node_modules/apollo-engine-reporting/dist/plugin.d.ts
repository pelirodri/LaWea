...
export declare const plugin: <TContext>(options: EngineReportingOptions<TContext> | undefined, addTrace: (args: AddTraceArgs) => Promise<void>, { startSchemaReporting, executableSchemaIdGenerator, }: {
