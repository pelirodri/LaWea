...
inline size_t utf_utils::utf8_char_utf16_code_point_len(const std::u8string &utf8_char) {
...
inline std::u16string utf_utils::utf8_char_to_utf16(const std::u8string &utf8_char) {
...
inline std::u8string utf_utils::utf16_char_to_utf8(const std::u16string &utf16_char) {
...
inline std::u16string utf_utils::utf8_str_to_utf16(const std::u8string &utf8_str) {
...
inline std::u8string utf_utils::utf16_str_to_utf8(const std::u16string &utf16_str) {
